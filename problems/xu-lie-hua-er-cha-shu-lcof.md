...
# 剑指 Offer 37. 序列化二叉树  LCOF - 序列化二叉树
...
[LeetCode](https://leetcode.com/problems/xu-lie-hua-er-cha-shu-lcof/description/)  -  [LeetCode-CN](https://leetcode-cn.com/problems/xu-lie-hua-er-cha-shu-lcof/description/)
## Latest Accepted Submissions - 最近一次 AC 的提交


| Language | Runtime | Memory | Submission Time |
|:---:|:---:|:---:|:---:|
| javascript  | 108 ms | 47.7 MB | 2021/11/10 15:13 |
