...
# 剑指 Offer 67. 把字符串转换成整数 LCOF - 把字符串转换成整数
...
[LeetCode](https://leetcode.com/problems/ba-zi-fu-chuan-zhuan-huan-cheng-zheng-shu-lcof/description/)  -  [LeetCode-CN](https://leetcode-cn.com/problems/ba-zi-fu-chuan-zhuan-huan-cheng-zheng-shu-lcof/description/)
## Latest Accepted Submissions - 最近一次 AC 的提交


| Language | Runtime | Memory | Submission Time |
|:---:|:---:|:---:|:---:|
| typescript  | 60 ms | 44 MB | 2022/04/30 15:50 |
...
function strToInt(str: string): number {
  ...
  if (strTrimed[0] === '+' || strTrimed[0] === '-' || typeof Number(strTrimed[0]) === 'number' && !isNaN(Number(strTrimed[0]))) {
    const parsed = parseInt(strTrimed);
    if (parsed > 2 ** 31 - 1) {
      return 2 ** 31 - 1
    } else if (parsed < - (2 ** 31)) {
      return - (2 ** 31);
